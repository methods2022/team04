# Code of Machine leanring, based on 23 features
...
# the number of different combintion of features
iteration = 500
...
for i in 1:iteration
    # Remove two features from feature list randomly
    global list = sample(1:25, 2, replace = false)

    X_sub = select(X, Not([list[1],list[2]]))
