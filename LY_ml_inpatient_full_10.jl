# Code of Machine Leanring, based on 15 features
...
# Number of different combinations of featuress.
iteration = 500
...
# load the data from file into DataFrame
...
for i in 1:iteration
    # remove 10 features from feature list randomly
    global list = sample(1:25, 10, replace = false)

    X_sub = select(X, Not([list[1],list[2],list[3],list[4],list[5],list[6],list[7],list[8],list[9],list[10]]))
    # println(names(X_sub))
